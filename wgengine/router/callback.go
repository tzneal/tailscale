...
type CallbackRouter struct {
	...
	// GetBaseConfigFn optionally specifies a function to return the current DNS
	...
	GetBaseConfigFn func() (dns.OSConfig, error)
